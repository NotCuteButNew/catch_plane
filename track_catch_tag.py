...
def initMove_2():
    time.sleep(1)
    print("*******************test********************\n")
    target = AK.setPitchRange((0, round(y_dis+grab_dis, 2), round(z_dis, 2)), -90, 0)
    servo_data = target[0]
...
def initMove():
    ...
    AK.setPitchRangeMoving((-30, 10, 18), 0,-90, 0, 1500)
...
def run(img):
    ...
    if tag_id is not None:
        ...
        if target:
            ...
            #if object_area < 400:
                print("***********st is true************\n")
                Board.setBusServoPulse(3, servo_data['servo3'], 2000)
                Board.setBusServoPulse(4, servo_data['servo4'], 2000)
                Board.setBusServoPulse(5, servo_data['servo5'], 2000)
                Board.setBusServoPulse(6, int(x_dis), 2000)
                time.sleep(2)
                st = False
            else: #track
                print("***********st is false************\n")
